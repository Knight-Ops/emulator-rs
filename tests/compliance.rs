...
#[test]
#[should_panic(expected = "Invalid instruction decoded from instruction : 0")]
fn test_add() {
    let mut cpu = emulator_rs::frontend::rv32i::cpu::CPU::new(16384);
...
#[test]
#[should_panic(expected = "Invalid instruction decoded from instruction : C0")]
fn test_sll() {
    let mut cpu = emulator_rs::frontend::rv32i::cpu::CPU::new(16384);
